        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-12">
            ...
            <p className="text-gray-500 font-medium italic">
              Informasi publik unit Sekolah Menengah Pertama Budiman Cendikia.
            </p>
          </div>
            ...
            <div className="space-y-10">
              <div className="bg-tosca-900 p-8 rounded-[40px] text-white shadow-xl">
                ...
                <p className="text-tosca-200 text-sm font-medium mb-8 leading-relaxed">
                  Bergabunglah dengan komunitas pembelajar SMP Budiman Cendikia.
                  Pendaftaran online 2026/2027.
                </p>
                <Link
                  href="/smp/ppdb"
                  className="block w-full py-4 bg-tosca-700 text-white text-center rounded-2xl font-black text-sm hover:bg-white hover:text-tosca-900 transition-all"
                >
                  Mulai Daftar Online
                </Link>
              </div>
